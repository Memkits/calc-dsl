...
{} (:package |calc-dsl)
  :configs $ {} (:init-fn |calc-dsl.main/main!) (:reload-fn |calc-dsl.main/reload!)
    :modules $ [] |respo.calcit/ |lilac/ |memof/ |respo-ui.calcit/ |respo-markdown.calcit/ |reel.calcit/
    :version |0.0.1
  :files $ {}
    |calc-dsl.core $ {}
      :ns $ quote (ns calc-dsl.core)
      :defs $ {}
        |calc-expr $ quote
